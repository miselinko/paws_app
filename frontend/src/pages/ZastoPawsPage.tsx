          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {REASONS.map((r, i) => (
              <Reveal key={r.title} delay={i * 80}>
                <div className="rounded-2xl p-7 h-full" style={{ backgroundColor: r.bg }}>
        ...
        <div className="max-w-5xl mx-auto">
          <Reveal>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
              <img src="https://images.unsplash.com/photo-1601758003122-53c40e686a19?q=80&w=600&auto=format&fit=crop" alt="Šetanje psa u gradu" className="w-full h-44 sm:h-56 object-cover rounded-2xl" />
              <img src="https://images.unsplash.com/photo-1554692918-08fa0fdc9db3?q=80&w=600&auto=format&fit=crop" alt="Vlasnica sa psom" className="w-full h-44 sm:h-56 object-cover rounded-2xl" />
              <img src="https://images.unsplash.com/photo-1541364983171-a8ba01e95cfc?q=80&w=600&auto=format&fit=crop" alt="Psi u parku" className="w-full h-44 sm:h-56 object-cover rounded-2xl col-span-2 sm:col-span-1" />
            </div>
          </Reveal>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {TESTIMONIALS.map((t, i) => (
              <Reveal key={t.name} delay={i * 100}>
                <div className="bg-white rounded-2xl p-7 h-full flex flex-col" style={{ boxShadow: '0 2px 16px rgba(0,0,0,0.06)' }}>
                  <div className="mb-3">
