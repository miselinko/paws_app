...
export const getAdminStats = () =>
  api.get<AdminStats>('/users/admin/stats/').then(r => r.data)

export const getAdminUsers = (params?: Record<string, string>) =>
  api.get<AdminUsersResponse>('/users/admin/users/', { params }).then(r => r.data)

export const getAdminUser = (id: number) =>
  api.get<AdminUserDetail>(`/users/admin/users/${id}/`).then(r => r.data)

export const toggleUserActive = (id: number, is_active: boolean) =>
  api.patch<AdminUserDetail>(`/users/admin/users/${id}/`, { is_active }).then(r => r.data)

export const toggleWalkerFeatured = (id: number, is_featured: boolean) =>
  api.patch<AdminUserDetail>(`/users/admin/users/${id}/`, { is_featured }).then(r => r.data)
...
export const getAdminReservations = (params?: Record<string, string>) =>
  api.get<PaginatedResponse<AdminReservation>>('/users/admin/reservations/', { params }).then(r => r.data)
...
export const getAdminReviews = (params?: Record<string, string>) =>
  api.get<PaginatedResponse<AdminReview>>('/users/admin/reviews/', { params }).then(r => r.data)
...
export const getAdminDogs = (params?: Record<string, string>) =>
  api.get<PaginatedResponse<AdminDog>>('/users/admin/dogs/', { params }).then(r => r.data)
