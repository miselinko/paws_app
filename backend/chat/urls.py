...
from .views import ConversationView, ConversationsListView, UnreadCountView, BotChatView, DeleteConversationView
...
urlpatterns = [
    ...
    path('<int:user_id>/delete/', DeleteConversationView.as_view(), name='conversation-delete'),
