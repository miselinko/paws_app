...
from .views import RegisterView, MyProfileView, ProfileImageView, WalkerProfileUpdateView, WalkerListView, WalkerDetailView, ForgotPasswordView, ResetPasswordView
